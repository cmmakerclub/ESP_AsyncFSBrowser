  ...
  if(type == WS_EVT_CONNECT){
    ...
    if(info->final && info->index == 0 && info->len == len){
      ...
      if (header == "MASTER:") {
        ...
        String macStr = msg.substring(7);

        // macStr.substring(0, 2);
        // macStr.substring(2, 4);
        // macStr.substring(4, 6);
        // macStr.substring(6, 8);
        // uint32_t b = strtoul(string, 0, 16);
        ...
        // Serial.printf("%s-%s-%s-%s-%s-%s", macStr)
        // uint8_t macTemp[6];
        // uint8_t b = strtoul(string, 0, 16);
        // strtoul(const char *__n, char **__end_PTR, int __base)
        // Serial.println()
      }
      else {
